...
const Login = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://myjobportal-byks.onrender.com/api/v1/user/login", input, {
        headers: {
    ...
    <div>
      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        ...
        >
          ...
          {
            loading ? <Button className="w-full my-4"><Loader2 className="mr-2 h-4 w-4 animate-spin" />pleases wait</Button> : <Button type="submit" className="w-full my-4 bg-black text-stone-100 hover:bg-slate-500">Login</Button>
          }
